...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='APFM-Net')
    ...
    parser.add_argument('--model', type=str, required=True, default='APFM-Net',
                        help='model name')
    ...
    parser.add_argument('--distil', action='store_false',
                        ...
                        default=True)
    parser.add_argument('--dropout', type=float, default=0.1, help='dropout 0.1')
    ...
    parser.add_argument('--learning_rate', type=float, default=0.0001, help='optimizer learning rate0.0001')
    ...
    #MICN
    parser.add_argument('--isometric_kernel', type=int, nargs='+', default=[1, 13], help='isometric convolution kernel_size')
    parser.add_argument('--conv_kernel', type=int, nargs='+', default=[5, 13], help='downsampling and upsampling convolution kernel_size')
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            setting = '{}_{}_{}_{}_ft{}_sl{}_ll{}_pl{}_wl{}_dm{}_nh{}_el{}_dl{}_df{}_fc{}_eb{}_dt{}_{}_{}'.format(
                args.task_name,
                args.model_id,
                args.model,
                args.data,
